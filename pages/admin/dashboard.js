      ...
      <div className="min-h-screen bg-gray-100">
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                <Link
                  href="/"
                  target="_blank"
                  className="text-gray-600 hover:text-gray-900 transition-colors text-sm sm:text-base hidden sm:inline"
                >
                  Voir le site
                </Link>
                <Link
                  href="/"
                  target="_blank"
                  className="text-gray-600 hover:text-gray-900 transition-colors sm:hidden"
                >
                ...
                <button
                  ...
                  className="bg-red-600 text-white px-3 py-2 sm:px-4 rounded-lg hover:bg-red-700 transition-colors text-sm sm:text-base"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg sm:text-xl font-bold text-purple-600">
                      {cars.length}
                    </dd>
                  </dl>
                </div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-0">
            ...
            <Link
              href="/admin/cars/new"
              className="bg-blue-600 text-white px-4 py-3 sm:py-2 rounded-lg hover:bg-blue-700 transition-colors text-center font-medium shadow-lg"
            >
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Êtes-vous sûr de vouloir supprimer le véhicule "{carToDelete?.Nom}" ? Cette action est irréversible.
                  </p>
                </div>
